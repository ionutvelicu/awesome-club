...
export const AuthResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getStatus(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthStatus>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getStatus(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthResourceApi.getStatus']?.[localVarOperationServerIndex]?.url;
        ...
        async register(authRequest: AuthRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthResourceApi.register']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class AuthResourceApi extends BaseAPI {
    ...
    public getStatus(options?: RawAxiosRequestConfig) {
        return AuthResourceApiFp(this.configuration).getStatus(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public login(authRequest: AuthRequest, options?: RawAxiosRequestConfig) {
        return AuthResourceApiFp(this.configuration).login(authRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public register(authRequest: AuthRequest, options?: RawAxiosRequestConfig) {
        return AuthResourceApiFp(this.configuration).register(authRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MemberResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        convertToAuthor: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MemberResourceApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = MemberResourceApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async convertToAuthor(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.convertToAuthor(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MemberResourceApi.convertToAuthor']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const MemberResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        convertToAuthor(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.convertToAuthor(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MemberResourceApi extends BaseAPI {
    ...
    public convertToAuthor(options?: RawAxiosRequestConfig) {
        return MemberResourceApiFp(this.configuration).convertToAuthor(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PaymentResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createCheckoutSession: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('createCheckoutSession', 'id', id)
            const localVarPath = `/payment/{id}/create-checkout-session`
         ...
         * @throws {RequiredError}
         */
        createSetupIntent: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('createSetupIntent', 'id', id)
            const localVarPath = `/payment/{id}/create-setup-intent`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getSessionStatus: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getSessionStatus', 'id', id)
            const localVarPath = `/payment/session/{id}/status`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const PaymentResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createCheckoutSession(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: string; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createCheckoutSession(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PaymentResourceApi.createCheckoutSession']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async createSetupIntent(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: string; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createSetupIntent(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PaymentResourceApi.createSetupIntent']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getSessionStatus(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: string; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSessionStatus(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PaymentResourceApi.getSessionStatus']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const PaymentResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createCheckoutSession(id: string, options?: RawAxiosRequestConfig): AxiosPromise<{ [key: string]: string; }> {
            return localVarFp.createCheckoutSession(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        createSetupIntent(id: string, options?: RawAxiosRequestConfig): AxiosPromise<{ [key: string]: string; }> {
            return localVarFp.createSetupIntent(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        getSessionStatus(id: string, options?: RawAxiosRequestConfig): AxiosPromise<{ [key: string]: string; }> {
            return localVarFp.getSessionStatus(id, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PaymentResourceApi extends BaseAPI {
    ...
    public createCheckoutSession(id: string, options?: RawAxiosRequestConfig) {
        return PaymentResourceApiFp(this.configuration).createCheckoutSession(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public createSetupIntent(id: string, options?: RawAxiosRequestConfig) {
        return PaymentResourceApiFp(this.configuration).createSetupIntent(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getSessionStatus(id: string, options?: RawAxiosRequestConfig) {
        return PaymentResourceApiFp(this.configuration).getSessionStatus(id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ProductResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        buyProduct: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('buyProduct', 'id', id)
            const localVarPath = `/products/{id}/buy`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        checkProductStatus: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('checkProductStatus', 'id', id)
            const localVarPath = `/products/{id}/status`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getProductsForAuthor: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/products`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getPurchasedProductDetails: async (purchasedId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'purchasedId' is not null or undefined
            assertParamExists('getPurchasedProductDetails', 'purchasedId', purchasedId)
            const localVarPath = `/products/purchased/{purchasedId}`
                .replace(`{${"purchasedId"}}`, encodeURIComponent(String(purchasedId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getPurchasedProducts: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        updateProduct: async (id: string, productDto: ProductDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const ProductResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async buyProduct(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BuyProductResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.buyProduct(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.buyProduct']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async checkProductStatus(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MemberProductStatusDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.checkProductStatus(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.checkProductStatus']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async createProduct(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductDto>> {
        ...
        async deleteProduct(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.deleteProduct']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getProduct(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProduct(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.getProduct']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getProductsForAuthor(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProductsForAuthor(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.getProductsForAuthor']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getPurchasedProductDetails(purchasedId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MemberProductDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPurchasedProductDetails(purchasedId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.getPurchasedProductDetails']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getPurchasedProducts(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MemberProductLightDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPurchasedProducts(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.getPurchasedProducts']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async updateProduct(id: string, productDto: ProductDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateProduct(id, productDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductResourceApi.updateProduct']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ProductResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        buyProduct(id: string, options?: RawAxiosRequestConfig): AxiosPromise<BuyProductResponse> {
            return localVarFp.buyProduct(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        checkProductStatus(id: string, options?: RawAxiosRequestConfig): AxiosPromise<MemberProductStatusDto> {
            return localVarFp.checkProductStatus(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        getProduct(id: string, options?: RawAxiosRequestConfig): AxiosPromise<ProductDto> {
         ...
         * @throws {RequiredError}
         */
        getProductsForAuthor(options?: RawAxiosRequestConfig): AxiosPromise<Array<ProductDto>> {
            return localVarFp.getProductsForAuthor(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} purchasedId 
         ...
         * @throws {RequiredError}
         */
        getPurchasedProductDetails(purchasedId: string, options?: RawAxiosRequestConfig): AxiosPromise<MemberProductDto> {
            return localVarFp.getPurchasedProductDetails(purchasedId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPurchasedProducts(options?: RawAxiosRequestConfig): AxiosPromise<Array<MemberProductLightDto>> {
            return localVarFp.getPurchasedProducts(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        updateProduct(id: string, productDto: ProductDto, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class ProductResourceApi extends BaseAPI {
    ...
    public buyProduct(id: string, options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).buyProduct(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public checkProductStatus(id: string, options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).checkProductStatus(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteProduct(id: string, options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).deleteProduct(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getProduct(id: string, options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).getProduct(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getProductsForAuthor(options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).getProductsForAuthor(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductResourceApi
     */
    public getPurchasedProductDetails(purchasedId: string, options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).getPurchasedProductDetails(purchasedId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getPurchasedProducts(options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).getPurchasedProducts(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductResourceApi
     */
    public updateProduct(id: string, productDto: ProductDto, options?: RawAxiosRequestConfig) {
        return ProductResourceApiFp(this.configuration).updateProduct(id, productDto, options).then((request) => request(this.axios, this.basePath));
    }
